...
Projeto desenvolvido para fins **didáticos e avaliativos** na disciplina *Programação para Internet II* Instituição: IFPI – Campus Pedro II  
...
1. **Análise do enunciado da atividade** Interpretação dos requisitos definidos pelo docente.
2. **Definição dos requisitos** Organização funcional e não funcional do sistema.
3. **Projeto da solução** Definição da arquitetura MVC e da estrutura do código.
4. **Implementação** Desenvolvimento incremental das funcionalidades.
5. **Verificação funcional** Validação manual dos principais fluxos do sistema.
6. **Documentação** Produção deste documento como artefato de engenharia.
...
**Observação didática:** O mecanismo de autenticação possui **usuário e senha previamente definidos**, sendo utilizado apenas para **exemplificação de controle de acesso**, não para fins de segurança real.

- Usuário: `adm`  
- Senha: `123`

**Justificativa:** A ISO/IEC 25010 define segurança como característica essencial, mesmo quando tratada de forma introdutória em sistemas educacionais.
...
**Justificativa:** O exercício de operações CRUD é prática consolidada no ensino de bancos de dados e aplicações web.
...
**Justificativa:** Permite exercitar relacionamentos entre entidades e integridade referencial.
...
**Justificativa:** A geração de documentos é frequentemente utilizada como critério de avaliação prática em cursos de programação.
...
**Justificativa:** Introduz conceitos de desacoplamento entre backend e apresentação, conforme práticas modernas documentadas na literatura.
...
**Justificativa:** A integridade dos dados é requisito básico de confiabilidade segundo a ISO/IEC 25010.
